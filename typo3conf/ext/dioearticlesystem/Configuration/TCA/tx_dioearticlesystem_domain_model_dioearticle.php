...
return [
    'ctrl' => [
        ...
        'searchFields' => 'prev_title,prev_text,a_task_cluster,detail_title,detail_text,z_name,z_title,z_l_name,z_l_text,p_duration,pub_title,pub_editors_sec,pub_booktitle,pub_publisher,pub_journal,pub_volume,pub_number,pub_series,pub_school,pub_address,pub_edition,pub_pages,pub_isbn,pub_doi,pub_url,pub_note,mee_titel,mee_persons_sec,mee_organisers_sec,mee_organisation_sec,mee_participants_sec,mee_text,mee_event,mee_adress,mee_url,mee_doi,mee_note',
        'iconfile' => 'EXT:dioearticlesystem/Resources/Public/Icons/tx_dioearticlesystem_domain_model_dioearticle.gif',
				'type' => 'a_type',
    ],
    'interface' => [
        'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, a_type, a_home, a_date, prev_title, prev_text, a_task_cluster, tags, start_pin, cat_pin, prev_pic, prev_pic_cropping_mode, detail_title, detail_text, detail_pic, detail_pic_cropping_mode, av_files, av_cols, av_aspect_ratio, f_files, z_user, z_name, z_title, z_place, z_l_name, z_share, z_com_share, z_l_text, p_file, p_duration, pub_type, pub_title, pub_editors_sec, pub_year, pub_month, pub_booktitle, pub_publisher, pub_journal, pub_volume, pub_number, pub_series, pub_school, pub_address, pub_edition, pub_pages, pub_keywords, pub_isbn, pub_doi, pub_url, pub_url_date, pub_note, mee_titel, mee_persons_sec, mee_organisers_sec,mee_organisation_sec, mee_participants_sec, mee_time, mee_end_time, mee_show_time, mee_text, mee_event, mee_adress, mee_url, mee_doi, mee_note, mee_keywords',
    ],
    'types' => [
        '0' => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, a_type, a_home, a_date, prev_title, prev_text, a_task_cluster, tags, start_pin, cat_pin, prev_pic, prev_pic_cropping_mode, --div--;Details, detail_title, detail_text, detail_pic, detail_pic_cropping_mode, --div--;Audio/Video, av_files, av_cols, av_aspect_ratio, --div--;Dateien, f_files, --div--;Zitation, z_user, z_name, z_title, z_place, z_l_name, z_share, z_com_share, z_l_text, --div--;Podcast, p_file, p_duration, --div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access, starttime, endtime'],
				'1' => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, a_type, a_home, a_date, prev_title, prev_text, a_task_cluster, tags, start_pin, cat_pin, prev_pic, prev_pic_cropping_mode, --div--;Publikation (BibText), pub_type, pub_title, pub_editors_sec, pub_year, pub_month, pub_booktitle, pub_publisher, pub_journal, pub_volume, pub_number, pub_series, pub_school, pub_address, pub_edition, pub_pages, pub_keywords, pub_isbn, pub_doi, pub_url, pub_url_date, pub_note, --div--;Dateien, f_files, --div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access, starttime, endtime'],
				'2' => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, a_type, a_home, a_date, prev_title, prev_text, a_task_cluster, tags, start_pin, cat_pin, prev_pic, prev_pic_cropping_mode, --div--;Termin, mee_titel, mee_persons_sec, mee_organisers_sec,mee_organisation_sec, mee_participants_sec, mee_time, mee_end_time, mee_show_time, mee_event, mee_adress, mee_url, mee_doi, mee_note, mee_keywords, --div--;Details, detail_title, detail_text, detail_pic, detail_pic_cropping_mode, --div--;Audio/Video, av_files, av_cols, av_aspect_ratio, --div--;Dateien, f_files, --div--;Zitation, z_user, z_name, z_title, z_place, z_l_name, z_share, z_com_share, z_l_text, --div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access, starttime, endtime'],
